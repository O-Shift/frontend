    ...
    return (
      <div className="flex-1 overflow-y-auto min-h-0 relative px-4 sm:px-6 lg:px-8 py-5">
        <div className="max-w-7xl mx-auto w-full">
          <WidgetErrorBoundary
            title="Video Analytics Error"
            message="An error occurred while loading video details and performance pacing charts."
            resetKeys={[selectedAsset.id]}
          >
            <VideoDetailView
              asset={selectedAsset}
  ...
  return (
    <div className="flex-1 overflow-y-auto min-h-0 relative px-4 sm:px-6 lg:px-8 py-5 space-y-4">
      ...
      <div className="max-w-7xl mx-auto w-full pb-16">
        <WidgetErrorBoundary
          title="Video Library Error"
          message="An error occurred while loading this video view."
          resetKeys={[activeTab, platformFilter, searchQuery, competitorFilter]}
        >
          {/* ══════════════════════════════════════════════════════════════ */}
